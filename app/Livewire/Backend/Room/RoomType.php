...
class RoomType extends Component
{
    ...
    public function setDefaltValues(){
        ...
        $this->slug = '';
        $this->species_id = 1;
        // Ensure create mode uses null so validation treats as create
        $this->room_type_id = null;
        $this->room_attributes = [];
        $this->room_amenities = [];
        $this->room_description = "";
   ...
   /* public function initiateDelete($roomTypeId)
    ...
    public function render()
    {
        ...
        $species = SpeciesModel::orderBy('name')->get();
       $serviceAddons = ProductModel::where('product_type', 'addon')->orderBy('name')->get();
        return view('livewire.backend.room.room-type', [
            'roomTypes' => $roomTypes,
            'species' => $species,
