...
/**
 * @OA\Tag(
 *     name="Room Cancel Setting",
 *     description="room-cancel-setting-specific APIs"
 * )
 * 
 */
class CancelSetting extends Component
{
    ...
    {
        \session(['submenu' => 'room-cancel-setting']);
    ...
    public function render()
    {
        try{
            ...
            return view('livewire.backend.room.cancel-setting', ['data' => $data]);
        } catch (Exception $e) {
            $e->getMessage();
        }
    }
    ...
    {
        return view('backend.room.cancel-setting');
    }
