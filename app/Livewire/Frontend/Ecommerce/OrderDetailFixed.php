...
class OrderDetail extends Component
{
    ...
    public function getItemProgressSteps($item)
    {
        // Get fulfillment status with fallback to pending
        $status = $item['fulfillment_status'] ?? 'pending';
        
        // Use explicit shippable flag from the item data
        $isShippable = $item['shippable'] ?? true; // Default to shippable if not specified
