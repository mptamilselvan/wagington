...
<x-auth-card>
    <div class="text-center">
        ...
        <h2 class="text-2xl font-bold mb-3 text-gray-800">Verification Successful!</h2>
        <p class="text-gray-600 mb-8 text-sm leading-relaxed">
            Your OTP has been verified successfully. You can now continue to your dashboard.
        </p>
