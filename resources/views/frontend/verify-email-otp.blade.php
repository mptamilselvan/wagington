...
<x-auth-card>
    <div>
        <h2 class="text-xl font-bold mb-2 text-center">Verify OTP</h2>
        <p class="text-gray-600 mb-8 mt-2 text-sm leading-6 text-center">
        ...
        <form method="POST" action="{{ route('customer.register.verifyEmailOtp') }}" class="space-y-6"
              onsubmit="
            ...
            <x-frontend.form-otp-input 
                ...
                label="Enter OTP"
                :required="true" 
                helpText="Please enter the 6-digit code sent to your email" />

            {{-- Confirmation message --}}
            <div class="text-center text-green-600 text-xs mb-4">
        ...
        <div class="text-center text-sm text-gray-600 mt-6 flex justify-center items-center">
            ...
            <form method="POST" action="{{ route('customer.register.resendEmailOtp') }}" class="inline-block">
                @csrf
