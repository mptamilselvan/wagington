...
<x-auth-card>
    <div>
        <h2 class="text-xl font-bold mb-2 text-center">Enter Your Email</h2>
        <p class="text-gray-600 mb-4 text-sm text-center">Please enter your email to complete registration.</p>

        <form method="POST" action="{{ route('customer.register.sendEmailOtp') }}" class="space-y-6">
            @csrf
