...
<x-auth-card>
    <div class="text-center">
        ...
        <h2 class="text-2xl font-bold mb-3 text-gray-800">Mobile Verified Successfully!</h2>
        <p class="text-gray-600 mb-8 text-sm leading-relaxed">
            Congratulations! Your mobile number has been verified successfully. You can now attach your email to continue.
        </p>

        <a href="{{ route('customer.register.attachEmailForm') }}"
