                    ...
                    <tbody>
                        @foreach ($data as $type)
                            <tr class="border-t">
                                ...
                                <td class="text-sm text-left text-gray-700">{{ $type->name }}</td>
                                <td class="text-sm text-left text-gray-700">{{ $type->description }}</td>
                                <td class="td">
                                    @component('components.three-dots-trigger', [
                                        'menuItems' => [
                                            ['label' => 'Edit', 'wireFn' => "edit($type->id)"],                                               
                                            ['label' => 'Delete', 'wireFn' => "deletePopUp($type->id)"],
                                        ],
                                    ])
                                    @endcomponent
                                </td>
