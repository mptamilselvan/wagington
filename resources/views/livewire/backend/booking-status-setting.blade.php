    ...
    <div class="flex gap-3 mx-3 my-3">
        <div class="w-1/5 p-4 bg-white">
            @component('components.subMenu', [
                'active' => 'admin.booking-status-setting',
        ...
        <div class="w-4/5 p-4 bg-white">
            ...
            <div class="mt-[28px] table-wrapper overflow-visible">
                <h4 class="mb-4 text-lg">Status</h4>
                ...
                <table class="min-w-full bg-white table-auto">
                    ...
                    <tbody>
                        @foreach ($data as $status)
                            <tr class="border-t">
                                <td class="text-sm text-left text-gray-700">{{ $status->name }}</td>
                                <td class="td">
                                    @component('components.three-dots-trigger', [
                                        'menuItems' => [
                                            ['label' => 'Edit', 'wireFn' => "edit($status->id)"],                                               
                                            ['label' => 'Delete', 'wireFn' => "deletePopUp($status->id)"],
                                        ],
                                    ])
                                    @endcomponent
                                </td>
