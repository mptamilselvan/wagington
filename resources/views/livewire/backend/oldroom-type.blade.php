           ...
           <div class="mt-10 overflow-visible table-wrapper">
            <h4 class="mb-4 text-lg">Submissions</h4>
              <table class="min-w-full bg-white table-auto">
                <thead>
                    <th class="text-sm p-6 font-normal text-left text-gray-500 border-b border-gray-200">Room Type</th>
                    <th class="th"></th>
                </thead>
                <tbody>
                    @foreach ($data as $roomType)
                    <tr>
                        <td class="text-sm text-left text-gray-700 p-6 border-b border-gray-200">
