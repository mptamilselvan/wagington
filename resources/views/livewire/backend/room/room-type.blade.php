            ...
            <div class="px-4 sm:px-6 pb-8">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    <div class="px-6 py-6">
                        ...
                        @if($editingRoomType)
                            @include('components.room.edit-room-type', ['roomTypes' => $roomTypes, 'species' => $species,  'serviceAddons' => $serviceAddons])
                        @else
                            @include('components.room.add-room-type', ['roomTypes' => $roomTypes, 'species' => $species,  'serviceAddons' => $serviceAddons])
                        @endif
