...
<div class="bg-white border border-gray-200 rounded-xl p-6 sticky top-6">
    ...
    <div class="border-t border-gray-200 pt-4">
        ...
        <!-- Action Buttons -->
        <div class="space-y-2">
            <a href="{{ route('customer.order-history') }}" class="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-2.5 px-4 rounded-lg transition-colors text-sm inline-flex items-center justify-center">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                </svg>
                My Order History
            </a>
            <a href="/shop" class="w-full bg-gray-900 hover:bg-gray-800 text-white font-medium py-2.5 px-4 rounded-lg transition-colors text-sm inline-flex items-center justify-center">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4m0 0L7 13m0 0l-1.5 1.5M7 13l1.5-1.5M20 13v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6" />
                </svg>
                Continue Shopping
            </a>
        </div>
    ...
    <div class="mt-6 text-xs text-gray-500 text-center">
        ...
        <p class="mt-2">Thank you for choosing The Wagington! Your furry friends are going to love their new items.</p>
    </div>
</div>