...
<div>
    <div class="relative">
        <!-- Hero banner -->
        <div class="h-40 sm:h-48 md:h-56 lg:h-64 bg-gray-200" style="height: 560px;">
            <img src="{{ $heroImage }}" alt="Rooms banner" class="w-full h-full object-cover" />
        </div>

        <!-- Floating card for title/search/tools -->
        <div class="absolute inset-x-0 -bottom-6 sm:-bottom-8 md:-bottom-10 lg:bottom-[-80px]">
            <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <!-- Limit width so it doesn't stretch full page -->
                <div class="max-w-7xl backdrop-blur-md rounded-2xl shadow-sm border border-gray-100 bg-gray-100 lg:py-8">
    ...
    <div
        class="w-full max-w-screen-2xl 2xl:max-w-[1660px] mx-auto px-4 sm:px-6 lg:px-8 pt-10 sm:pt-12 md:pt-16 g-gradient-to-b bg-white rom-primary-blue to-white min-h-screen">
        <div class="lg:mt-16">
            {{ $slot }}
            ...
            @livewire('frontend.room.pop-book')
        </div>
    </div>
</div>
