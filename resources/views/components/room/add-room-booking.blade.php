<div class="mb-6 bg-white border border-gray-200 rounded-lg shadow-sm">
    <div class="px-6 py-6">
        ...
        <div class="flex justify-end gap-4 mt-8 pt-6 border-t border-gray-200">
            ...
            <button type="button" wire:click="saveRoomBooking" wire:loading.attr="disabled"
                wire:loading.class="opacity-50 cursor-not-allowed"
                class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
                <span wire:loading.remove wire:target="saveRoomBooking">
                    Save Room Booking
                </span>
                <span wire:loading wire:target="saveRoomBooking" class="flex items-center">
